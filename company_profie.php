...
<body>
  ...
  <div class="header">
    ...
    <h2 style="color: whitesmoke;">Company Profile</h2>
      ...
      <div>
        ...
        <div class="menu">
          ...
          <ul>
              ...
              <li>
                  <a href="logout_company.php" style="color: red;">
  ...
  echo $usn;
   ...
   if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
       ...
       $address=array( $row["organisation_name"],$row["email"],$row["phone_number"],$row["region"],$row["domain"],$row["hiring_for"],$row["qualification"],$row["address"]);
